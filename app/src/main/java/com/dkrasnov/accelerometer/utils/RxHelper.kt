package com.dkrasnov.accelerometer.utils
...
class RxHelper {
    ...
    companion object {
        ...
        fun <T> makeBackground(single: Single<T>): Single<T> {
            return single.background()
        }

        fun makeBackground(completable: Completable): Completable {
            return completable.background()
        }
